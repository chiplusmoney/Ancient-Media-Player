 ...
 */
package player.music.ancient.fragments.folder
...
import player.music.ancient.ThemeStore.Companion.accentColor
...
import player.music.ancient.adapter.SongFileAdapter
import player.music.ancient.adapter.Storage
import player.music.ancient.adapter.StorageAdapter
import player.music.ancient.adapter.StorageClickListener
import player.music.ancient.databinding.FragmentFolderBinding
...
import player.music.ancient.helper.MusicPlayerRemote.openQueueKeepShuffleMode
import player.music.ancient.helper.ScanMusicBottomSheet

import player.music.ancient.helper.menu.SongMenuHelper
import player.music.ancient.helper.menu.SongsMenuHelper
import player.music.ancient.interfaces.ICallbacks
import player.music.ancient.interfaces.IMainActivityFragmentCallbacks
import player.music.ancient.interfaces.IScrollHelper
import player.music.ancient.misc.FolderMediaScannerCompletionListener

import player.music.ancient.misc.WrappedAsyncTaskLoader
import player.music.ancient.model.Song
import player.music.ancient.providers.BlacklistStore
import player.music.ancient.util.FileUtil
import player.music.ancient.util.PreferenceUtil.startDirectory
import player.music.ancient.util.PreferenceUtil.lastDirectory
import player.music.ancient.util.PreferenceUtil.saveLastDirectory
import player.music.ancient.util.ThemedFastScroller.create
import player.music.ancient.util.getExternalStorageDirectory
import player.music.ancient.util.getExternalStoragePublicDirectory
import player.music.ancient.views.BreadCrumbLayout
import player.music.ancient.views.BreadCrumbLayout.Crumb
import player.music.ancient.views.BreadCrumbLayout.SelectionCallback

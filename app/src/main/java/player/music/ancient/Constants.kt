...
object Constants {
    ...
    const val RATE_ON_GOOGLE_PLAY =
        "https://play.google.com/store/apps/details?id=player.music.ancient"
    const val TRANSLATE = "https://crowdin.com/project/ancientmusicplayer"
    const val WEBSITE = "https://ancientmusic.app"
    const val GITHUB_PROJECT = "https://github.com/AncientMusicPlayer/AncientMusicPlayer"
    const val TELEGRAM_CHANGE_LOG = "https://t.me/ancientmusiclog"
    const val USER_PROFILE = "profile.jpg"
    const val USER_BANNER = "banner.jpg"
    const val APP_TELEGRAM_LINK = "https://t.me/ancientmusicapp/"
    const val APP_TWITTER_LINK = "https://twitter.com/ancientmusicapp"
    const val FAQ_LINK = "https://github.com/AncientMusicPlayer/AncientMusicPlayer/blob/master/FAQ.md"
    const val PINTEREST = "https://in.pinterest.com/ancientmusicapp/"
...
const val SHOW_RADIO_FAB = "show_radio_fab"
const val RADIO_FAB_X = "radio_fab_x"
const val RADIO_FAB_Y = "radio_fab_y"
const val MINI_PLAYER_X = "mini_player_x"
const val MINI_PLAYER_Y = "mini_player_y"
const val HOME_SHORTCUTS = "home_shortcuts"
const val TV_DEFAULTS_INITIALIZED = "tv_defaults_initialized"
const val TV_DEFAULTS_VERSION = "tv_defaults_version"
const val YOUTUBE_DEFAULTS_INITIALIZED = "youtube_defaults_initialized"
const val YOUTUBE_FEED_LAST_SYNC_AT = "youtube_feed_last_sync_at"
const val YOUTUBE_FEED_LAST_ATTEMPT_AT = "youtube_feed_last_attempt_at"
const val YOUTUBE_FEED_LAST_FAILURE_KIND = "youtube_feed_last_failure_kind"
const val YOUTUBE_FEED_SYNC_SIGNATURE = "youtube_feed_sync_signature"

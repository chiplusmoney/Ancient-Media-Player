...
import player.music.ancient.App.Companion.getContext
...
object AncientUtil {
    ...
    fun getIpAddress(useIPv4: Boolean): String? {
        try {
            ...
            Log.e("AncientUtil", "No suitable network interface found")
        } catch (e: Exception) {
            Log.e("AncientUtil", "Error getting IP address: ${e.message}")
        }
        return null
    }
}